...
import { Phone, Mail, Clock, MapPin, Home, Info, Briefcase, HelpCircle, FileText, MessageSquare, Facebook, Twitter, Youtube, Instagram, Linkedin } from 'lucide-react';
  ...
  return (
    <footer className="bg-black text-gray-100 sm:pt-24 pt-16 pb-8 w-full">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
        ...
        {/* Footer Bottom */}
        <div className=" pt-5 text-center text-xs sm:text-sm text-gray-600">
