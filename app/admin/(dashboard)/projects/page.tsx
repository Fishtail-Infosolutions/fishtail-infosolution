...
export default function ProjectsPage() {
    ...
    const updateOrder = async (items: Project[]) => {
        try {
            ...
            fetchProjects(); // roll back to DB state
        } finally {
        ...
        <div className="space-y-8 animate-in fade-in duration-500 p-4 md:p-0">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                    {isReordering && (
                        <span className="text-sm text-blue-500 flex items-center gap-2 animate-pulse">
                    ...
                    >
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                                <SortableContext
                                    items={paginatedProjects.map((item) => item._id)}
                                ...
                                >
                                    {paginatedProjects.length === 0 ? (
                                        ...
                                        paginatedProjects.map((project) => (
                                            <SortableRow key={project._id} project={project}>
                                                {/* Project info */}
                                                ...
                                                <td className="px-6 py-5 text-right">
                                                    <Popover>
                                                        ...
                                                        <PopoverContent
                                                            className="w-48 p-2 bg-white dark:bg-[#0B0F1A] border-gray-200 dark:border-gray-800 z-150"
                                                            align="end"
                                                        >
